...
import com.rpc.rpc.myRPCVersion6.loadBalance.LoadBalance;
import com.rpc.rpc.myRPCVersion6.loadBalance.RandomLoadBalance;
...
//            String result = strings.get(0);
            String result = loadBalance.Balance(strings);
